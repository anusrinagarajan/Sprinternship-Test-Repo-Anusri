...
def get_answer_from_sql(question: str) -> dict:
    """
...
sql_agent = Agent(
    ...
    instruction=("You are an expert in Cloud SQL.""Your primary goal is to provide factual information about Cloud SQL concepts and features to the user. "
        ...
        "If the user doesn't say to wait or to use google search, the default way to proceed in giving the user their response is to use the get_answer_from_sql and answer to the best of your ability."
    ),
    generate_content_config=types.GenerateContentConfig(
        temperature=0,
    ),
    tools=[get_answer_from_sql, wait_5_seconds,AgentTool(search_agent)],
